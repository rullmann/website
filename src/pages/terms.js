    ...
    <Layout>
        ...
        <div className={"container"}>
            <div className={"content"}>
                ...
                <p>1.1 These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (<strong>you</strong>), and <strong>Ferdi</strong>, doing business as<strong> Ferdi</strong> <strong>(https://getferdi.com) </strong>website as well as any related applications (the <strong>Site</strong>). &nbsp;</p>
                <p>The Site provides the following services: Inform you about the Ferdi desktop application. You agree that by accessing the Site and/or Services, you have read, understood, and agree to be bound by all of these Terms and Conditions. &nbsp;</p>
                ...
                <p>1.5 Our site is directed to people residing in Europe. The information provided on the Site is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. &nbsp;</p>
                ...
                <p><strong>&mdash; </strong>Our Privacy Notice https://getferdi.com/privacy, which sets out the terms on which we process any personal data we collect from you, or that you provide to us. By using the Site, you consent to such processing and you warrant that all data provided by you is accurate. &nbsp;</p>
                <p><strong>&mdash; </strong>Our Acceptable Use Policy contact@getferdi.com, which sets out the permitted uses and prohibited uses of the Site. When using the Site, you must comply with this Acceptable Use Policy. &nbsp;</p>
                
                <h3><strong>2. </strong>&nbsp;<strong>Acceptable Use </strong> </h3>
                <p>2.1 Our full Acceptable Use Policy contact@getferdi.com, sets out all the permitted uses and prohibited uses of this site. &nbsp;</p>
                ...
                <p>If you know or suspect that anyone other than you knows your user information (such as an identification code or user name) and/or password you must promptly notify us at contact@getferdi.com.</p>
                ...
                <p>4.3 In posting User Content, including reviews or making contact with other users of the Site you shall comply with our Acceptable Use Policy contact@getferdi.com. &nbsp;</p>
                ...
                <p>4.7 If you wish to complain about User Content uploaded by other users please contact us at contact@getferdi.com or use the take down or report button. &nbsp;&nbsp;&nbsp;</p>
                ...
                <p>11.11 In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at contact@getferdi.com</p>
            </div>
        </div>
    </Layout>
)
